        ...
        @endif
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="form-group">
                    <label for="email" class="form-label">Enter Your Password</label>
                ...
                <div class="form-group mt-3">
                    <label for="password" class="form-label">Enter Your Conform Password</label>
                    <div class="input-group">
            ...
            <div class="col-md-12 mt-4">
                <div class="form-group">
                    <button class="btn btn-gradient-dark w-100 btn-rounded">Reset Password</button>
                </div>
            </div>
        </div>
    </form>
