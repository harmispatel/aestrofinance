            ...
            <div class="col-md-8">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ trans('label.GrahWiseData') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-4" style="text-align: right;">
                <a href="{{ route('grahsdata.create') }}" class="btn btn-sm new-category custom-btn">
                                ...
                                <div class="form_box_inr">
                                    ...
                                    <div class="form_box_info">
                                        <div class="table-responsive">
                                            <table class="table w-100 dataTable no-footer" id="GrahWiseDataTable"
...
@section('page-js')
    ...
    <script type="text/javascript">
       ...
       $(document).ready(function() {
            ...
            var table = $('#GrahWiseDataTable').DataTable({
                processing: true,
                serverSide: true,
                pageLength: 100,
                ajax: {
                    url: "{{ route('grahsdata.index') }}",
                    data: function(d) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success == 1) {
                                    ...
                                    $('#GrahWiseDataTable').DataTable().ajax.reload();
                                } else {
